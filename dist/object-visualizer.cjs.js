...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  return (openBlock(), createBlock("span", _hoisted_1$2, [
    createVNode("span", _hoisted_2$2, toDisplayString($props.name), 1 /* TEXT */),
    ($props.name !== '')
      ? (openBlock(), createBlock("span", _hoisted_3$2, ": "))
      : createCommentVNode("v-if", true),
    createVNode("span", _hoisted_4$2, toDisplayString($props.data), 1 /* TEXT */)
  ]))
}
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createBlock("span", _hoisted_1$5, [
    ...
    }, toDisplayString($props.name === "" ? "" : $props.name), 1 /* TEXT */),
    createVNode("span", {
      class: "separator",
      onClick: _cache[3] || (_cache[3] = (...args) => ($setup.handleClick(...args)))
    }, toDisplayString($props.name === "" ? "" : ": "), 1 /* TEXT */),
    createVNode("span", {
      class: "count",
      onClick: _cache[4] || (_cache[4] = (...args) => ($setup.handleClick(...args)))
    }, toDisplayString($setup.isExpanding === false && $props.data.length >= 2 ? "(" + $props.data.length + ")" : ""), 1 /* TEXT */),
    createVNode("span", {
      class: "preview",
      onClick: _cache[5] || (_cache[5] = (...args) => ($setup.handleClick(...args)))
